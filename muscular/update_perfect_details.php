        ...
        <section class="main-page">
            <div class="main-top">
             ...
             if(isset($_GET['update_details'])){
              ...
              $update_st_details = $_GET['update_details'];
              $query = "SELECT * FROM student_details where full_name= '$update_st_details'";
...
if(isset($_POST['submit'])) {
  ...
  $update_st_details = $_GET['update_details'];
    ...
    $sql = "UPDATE student_details set  full_name='$full_name',email='$email',phone='$phone',birth_date='$birth_date',course='$course',gender='$gender',addres='$addres',country='$country',states='$states',city='$city',postal_code='$postal_code'  where full_name = '$update_st_details'";
...
if(isset($_POST['delete'])) {
  ...
  $update_st_details = $_GET['update_details'];
    ...
    $sql = "delete from student_details where full_name = '$update_st_details' ";
	if ($conn->query($sql) === TRUE) {
